<template>
  ...
  >
    ...
    <div class="flex items-center gap-5 max-w-[498px] mx-auto relative">
      <div class="flex-1 flex flex-col items-center gap-7">
        ...
        />
        <Typography class="text-primary-300">Decline</Typography>
      </div>
      <div class="flex-1 flex flex-col items-center gap-7">
        <div
        ...
        />
        <Typography class="text-primary-300">High Risk</Typography>
      </div>
      <div class="flex-1 flex flex-col items-center gap-7">
        <div
        ...
        />
        <Typography class="text-primary-300">Medium Risk</Typography>
      </div>
      <div class="flex-1 flex flex-col items-center gap-7">
        <div
        ...
        />
        <Typography class="text-primary-300">Low Risk</Typography>
      </div>
    </div>
  </div>
</template>
